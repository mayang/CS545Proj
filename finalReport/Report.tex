...
Markov Decision Processes (MDPs) proved to be a decently effective framework for enemy tracking in dynamic Robocode environments. Though generating new, optimal policies took a number of Robocode
...
procedure with rigorous offline and online testing, and the results were quite exciting. We saw noticeable improvement in the tracking ability of our MDP bots when we utilized this real-time update at close proximity to the enemy.
